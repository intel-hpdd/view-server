...
describe('get services request', () => {
  let getServicesRequest,
    getReq,
    req;

  beforeEach(() => {
    req = {
      bufferRequest: jasmine
        .createSpy('bufferRequest')
    };
    ...
    getServicesRequest = proxyquire('../source/supervisor/get-services-request', {
      'intel-req': getReq
    }).default;
  });
