...
describe('get stopped supervisor services', () => {
  ...
  beforeEach(() => {
    ...
    .and
    .returnValue(highland([null]));

    getStoppedSupervisorServices = proxyquire('../source/supervisor/get-stopped-supervisor-services', {
      'intel-xml-2-json': xml2Json,
